...
#ifndef __STM32G4XX_NUCLEO_H
#define __STM32G4XX_NUCLEO_H
...
/** @defgroup STM32G4XX_NUCLEO
 * @{
 */

/** @defgroup STM32G4XX_NUCLEO_LOW_LEVEL
 * @{
 */
...
/** @defgroup STM32L4XX_NUCLEO_LOW_LEVEL_Exported_Constants LOW LEVEL Exported Constants
  ...
  */
/**
 * @brief STM32G4XX NUCLEO BSP Driver version number V1.0.0
 */
#define __STM32G4XX_NUCLEO_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define __STM32G4XX_NUCLEO_BSP_VERSION_SUB1   (uint32_t)(0x00) /*!< [23:16] sub1 version */
#define __STM32G4XX_NUCLEO_BSP_VERSION_SUB2   (uint32_t)(0x00) /*!< [15:8]  sub2 version */
#define __STM32G4XX_NUCLEO_BSP_VERSION_RC     (uint32_t)(0x00) /*!< [7:0]  release candidate */
#define __STM32G4XX_NUCLEO_BSP_VERSION        ((__STM32G4XX_NUCLEO_BSP_VERSION_MAIN << 24)\
                                                    |(__STM32G4XX_NUCLEO_BSP_VERSION_SUB1 << 16)\
                                                    |(__STM32G4XX_NUCLEO_BSP_VERSION_SUB2 << 8 )\
                                                    |(__STM32G4XX_NUCLEO_BSP_VERSION_RC))

/** @defgroup STM32G4XX_NUCLEO_LOW_LEVEL_Exported_Types STM32G4XX_NUCLEO LOW LEVEL Exported Types
 * @{
 */
...
/** @defgroup STM32G4XX_NUCLEO_LOW_LEVEL_COM STM32G4XX_NUCLEO LOW LEVEL COM
 * @{
 */
/**
...
#define BUS_LPUART1_TX_GPIO_AF GPIO_AF12_LPUART1
...
#define BUS_LPUART1_RX_GPIO_AF GPIO_AF12_LPUART1
...
/** @defgroup STM32G4XX_NUCLEO_LOW_LEVEL_Exported_Functions STM32G4XX_NUCLEO LOW LEVEL Exported Functions
 * @{
 */
