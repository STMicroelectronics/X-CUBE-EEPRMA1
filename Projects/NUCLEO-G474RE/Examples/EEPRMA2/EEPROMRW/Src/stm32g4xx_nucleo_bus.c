...
/** @defgroup STM32G4XX_NUCLEO_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32G4XX_NUCLEO_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup STM32G4XX_NUCLEO_BUS_Exported_Functions STM32G4XX_NUCLEO_BUS Exported Functions
  * @{
  */
