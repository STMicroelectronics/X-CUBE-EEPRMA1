...
void M95_TestSingleByte(unsigned int  TargetAddress,uint32_t TargetName,int32_t expWriteStatus,int32_t expReadStatus);
void M24_TestData(unsigned int  TargetAddress,uint32_t TargetName, uint8_t tx[],uint8_t rx[],uint16_t size,int32_t expWriteStatus,int32_t expReadStatus);
void M95_TestData(unsigned int  TargetAddress,uint32_t TargetName, uint8_t tx[],uint8_t rx[],uint16_t Size,int32_t expWriteStatus,int32_t expReadStatus);
void M24_TestPage(unsigned int  TargetAddress,uint32_t TargetName,uint8_t tx[],uint8_t rx[],uint16_t size,int32_t expWriteStatus,int32_t expReadStatus);
void M95_TestPage(unsigned int  TargetAddress,uint32_t TargetName,uint8_t tx[],uint8_t rx[],uint16_t size,int32_t expWriteStatus,int32_t expReadStatus);
void TestData_WriteProtect(unsigned int  TargetAddress,uint8_t TargetName, uint8_t tx[],uint8_t rx[],uint16_t Size,int32_t expWriteStatus,int32_t expReadStatus);
int32_t WriteEnableReadStatus(uint32_t TargetName);
int32_t WriteDisableReadStatus(uint32_t TargetName);
int32_t TestData_BlockProtect (uint8_t BlockProtect,unsigned int  TargetAddress,uint8_t TargetName, uint8_t tx[],uint8_t rx[],uint16_t Size);
...
void MX_EEPROM_RW_Init(void)
{
 ...
 /*EEPROM I2C : Multiple Bytes read/write*/
  ...
  M95_ReadID( EEPRMA1_M95M01_0, 0x00 );
  M95_WriteID(EEPRMA1_M95M01_0, 0x00 );
  M95_ReadID( EEPRMA1_M95M01_0, 0x00 );
  M95_LockStatus( EEPRMA1_M95M01_0);

  /*
  Uncomment this function to permanently Lock ID Page on EEPRMA1_M95M01_0

  M95_LockID(EEPRMA1_M95M01_0);
...
/**
  ...
  * @retval EEPROMEX enum status
  */
int32_t TestData_BlockProtect(uint8_t Block_Protect,unsigned int  TargetAddress, uint8_t TargetName, uint8_t tx[],uint8_t rx[],uint16_t Size)
{
  int32_t readstatus = BSP_ERROR_NONE;
...
int32_t M95_ReadID(uint32_t TargetName, const unsigned int TargetAddress)
{
  ...
  readstatus =  EEPRMA1_M95_ReadID(TargetName, rx, TargetAddress, 15 );
...
int32_t M95_WriteID(uint32_t TargetName, const uint32_t TargetAddress)
{
  ...
  writestatus =  EEPRMA1_M95_WriteID(TargetName, tx, TargetAddress, size );
...
int32_t M95_LockStatus(uint32_t TargetName)
{
  ...
  readstatus = EEPRMA1_M95_LockStatus(TargetName, rx);
...
int32_t M95_LockID(uint32_t TargetName)
{
  ...
  status =  EEPRMA1_M95_LockID(TargetName);
