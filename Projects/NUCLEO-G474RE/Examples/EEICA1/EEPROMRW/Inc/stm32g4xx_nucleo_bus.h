...
/** @defgroup STM32G4XX_NUCLEO_BUS_Exported_Constants STM32G4XX_NUCLEO BUS Exported Constants
  * @{
  */
...
/** @defgroup STM32G4XX_NUCLEO_BUS_Private_Types STM32G4XX_NUCLEO BUS Private types
  * @{
  */
