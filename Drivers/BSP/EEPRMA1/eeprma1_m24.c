 ...
 * @brief   This file provides X-NUCLEO-EEPRMA1 Board specific  based on m24xx series eeprom driver
  ******************************************************************************
  * @attention
  *
 ...
 * @{
 */
static M24_EEPROM_CommonDrv_t *M24Drv[EEPRMA1_M24_INSTANCES_NBR];
void *M24CompObj[EEPRMA1_M24_INSTANCES_NBR];
...
/** @defgroup EEPRMA1_M24_Exported_Functions 
 * @{
 */
...
int32_t EEPRMA1_M24_DeInit(uint32_t Instance)
{
  ...
  if (Instance >= EEPRMA1_M24_INSTANCES_NBR)
  {
    ret = BSP_ERROR_WRONG_PARAM;
  }
...
{
  int32_t ret;
  EEPRMA1_M24MemorySizeLocator(Instance);
...
int32_t EEPRMA1_M24_WriteByte (uint32_t Instance, uint8_t * const pData, const uint32_t TarAddr)
{
  ...
  else
  {
    ...
    while ( EEPRMA1_M24_IsDeviceReady(Instance, MIN_TRIALS) != BSP_ERROR_NONE ) {};
    ret = BSP_ERROR_NONE;
  }
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M24_WritePage(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr, const uint16_t Size)
{
  int32_t ret;
  EEPRMA1_M24MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M24_WriteID(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr, const uint16_t Size )
{
  int32_t ret;
  EEPRMA1_M24MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M24_ReadID(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr, const uint16_t Size )
{
  int32_t ret;
  EEPRMA1_M24MemorySizeLocator(Instance);
...
static int32_t M24C02_0_Probe(void)
{
  ...
  io_ctxc02.Init        = EEPRMA1_I2C_Init;
  io_ctxc02.DeInit      = EEPRMA1_I2C_DeInit;
  io_ctxc02.ReadReg     = EEPRMA1_I2C_ReadReg;
  io_ctxc02.WriteReg    = EEPRMA1_I2C_WriteReg;
  io_ctxc02.ReadReg16   = EEPRMA1_I2C_ReadReg16;
  io_ctxc02.WriteReg16  = EEPRMA1_I2C_WriteReg16;
  io_ctxc02.Transmit    = EEPRMA1_I2C_Send;
  io_ctxc02.IsReady     = EEPRMA1_I2C_IsReady;	
  io_ctxc02.Delay       = EEPRMA1_M24_Delay;
  if (M24_RegisterBusIO(&M24C02_obj_0, &io_ctxc02) != M24_OK)
  {
    ret = BSP_ERROR_UNKNOWN_COMPONENT;
  }

  M24CompObj[EEPRMA1_M24C02_0] = &M24C02_obj_0;
  M24Drv[EEPRMA1_M24C02_0] = (M24_EEPROM_CommonDrv_t *)(void *)&M24_i2c_Drv;

  if (M24Drv[EEPRMA1_M24C02_0]->Init( M24CompObj[EEPRMA1_M24C02_0]) != M24_OK)
    {
      ret = BSP_ERROR_COMPONENT_FAILURE;
    }
  else
...
static int32_t M24256_0_Probe(void)
{
  ...
  io_ctx256.Init        = EEPRMA1_I2C_Init;
  io_ctx256.DeInit      = EEPRMA1_I2C_DeInit;
  io_ctx256.ReadReg     = EEPRMA1_I2C_ReadReg;
  io_ctx256.WriteReg    = EEPRMA1_I2C_WriteReg;
  io_ctx256.ReadReg16   = EEPRMA1_I2C_ReadReg16;
  io_ctx256.WriteReg16  = EEPRMA1_I2C_WriteReg16;
  io_ctx256.Transmit    = EEPRMA1_I2C_Send;
  io_ctx256.IsReady     = EEPRMA1_I2C_IsReady;	
  io_ctx256.Delay       = EEPRMA1_M24_Delay;
  if (M24_RegisterBusIO(&M24256_obj_0, &io_ctx256) != M24_OK)
  {
    ret = BSP_ERROR_UNKNOWN_COMPONENT;
  }
  
  M24CompObj[EEPRMA1_M24256_0] = &M24256_obj_0;
  M24Drv[EEPRMA1_M24256_0] = (M24_EEPROM_CommonDrv_t *)(void *)&M24_i2c_Drv;

  if (M24Drv[EEPRMA1_M24256_0]->Init(M24CompObj[EEPRMA1_M24256_0]) != M24_OK)
    {
      ret = BSP_ERROR_COMPONENT_FAILURE;
    }
  else
...
static int32_t M24M01_0_Probe(void)
{
  ...
  io_ctxm01.Init        = EEPRMA1_I2C_Init;
  io_ctxm01.DeInit      = EEPRMA1_I2C_DeInit;
  io_ctxm01.ReadReg     = EEPRMA1_I2C_ReadReg;
  io_ctxm01.WriteReg    = EEPRMA1_I2C_WriteReg;
  io_ctxm01.ReadReg16   = EEPRMA1_I2C_ReadReg16;
  io_ctxm01.WriteReg16  = EEPRMA1_I2C_WriteReg16;
  io_ctxm01.Transmit    = EEPRMA1_I2C_Send;
  io_ctxm01.IsReady     = EEPRMA1_I2C_IsReady;
  io_ctxm01.Delay       = EEPRMA1_M24_Delay;
  if (M24_RegisterBusIO(&M24M01_obj_0, &io_ctxm01) != M24_OK)
  {
    ret = BSP_ERROR_UNKNOWN_COMPONENT;
  }
  
  M24CompObj[EEPRMA1_M24M01_0] = &M24M01_obj_0;
  M24Drv[EEPRMA1_M24M01_0] = (M24_EEPROM_CommonDrv_t *)(void *)&M24_i2c_Drv;

  if (M24Drv[EEPRMA1_M24M01_0]->Init(M24CompObj[EEPRMA1_M24M01_0]) != M24_OK)
    {
      ret = BSP_ERROR_COMPONENT_FAILURE;
    }
  else
