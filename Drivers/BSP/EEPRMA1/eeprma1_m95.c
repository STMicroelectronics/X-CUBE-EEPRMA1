/**
  ...
  * @brief   This file provides X-NUCLEO-EEPRMA1 Board specific functions
  ******************************************************************************
  * @attention
  *
 ...
 * @{
 */
static M95_EEPROM_CommonDrv_t *M95Drv[EEPRMA1_M95_INSTANCES_NBR];
void *M95CompObj[EEPRMA1_M95_INSTANCES_NBR];
...
/* Global variables ----------------------------------------------------------*/
EEPROMEX_CtrlPin_TypeDef EEPROMEX_CtrlPin[7] = { { M95M01_EEPROM_SPI_CS_PIN, M95M01_EEPROM_SPI_CS_PORT },
                                                    ...
                                                    { EEPRMA1_M24_WC_PIN, EEPRMA1_M24_WC_PORT },
                                                    { EEPRMA1_M95_HOLD_PIN, EEPRMA1_M95_HOLD_PORT },
                                                    { EEPRMA1_M95_WP_PIN, EEPRMA1_M95_WP_PORT } }; 
 ...
 * @retval BSP status
 */
int32_t EEPRMA1_M95_Init(uint32_t Instance)
{
  ...
  switch (Instance)
  {
   case EEPRMA1_M95M01_0:
    if (M95M01_0_Probe() != BSP_ERROR_NONE)
      {
 ...
 * @retval BSP status
 */
int32_t EEPRMA1_M95_DeInit(uint32_t Instance)
{
  int32_t ret;

  if (Instance >= EEPRMA1_M95_INSTANCES_NBR)
  {
    ret = BSP_ERROR_WRONG_PARAM;
  }
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_ReadReg(uint32_t Instance, uint8_t * pData)
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_WriteReg(uint32_t Instance, uint8_t pData)
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_ReadByte(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr)
{
   int32_t ret;
   EEPRMA1_M95MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_ReadPage(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr, const uint16_t Size)
{
   int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_ReadData(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr,  const uint16_t Size)
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
  if ((TarAddr + Size)>M95MemorySize)
...
/**
  ...
  */
int32_t EEPRMA1_M95_WriteByte(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr)
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_WritePage(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr, const uint16_t Size)
{
   int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
  if ((TarAddr + Size)>M95MemorySize)
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_WriteData(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr,  const uint16_t Size)
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
  if ((TarAddr + Size)>M95MemorySize)
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_WriteID(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr, const uint16_t Size )
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_ReadID(uint32_t Instance, uint8_t * pData, const uint32_t TarAddr, const uint16_t Size )
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_LockStatus( uint32_t Instance, uint8_t * pData)
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
...
/**
  ...
  * @retval BSP status
  */
int32_t EEPRMA1_M95_LockID( uint32_t Instance)
{
  int32_t ret;
  EEPRMA1_M95MemorySizeLocator(Instance);
...
int32_t EEPRMA1_SPI_ReadReg(uint8_t * pData, uint8_t Devaddr)
{
 EEPROMEX_CTRL_LOW( Devaddr & EEPROMEX_SPI_SLAVESEL );
 if ( EEPRMA1_M95_IOWrite( EEPROMEX_RDSR ) != BSP_ERROR_NONE )
    return BSP_ERROR_COMPONENT_FAILURE;
  if ( EEPRMA1_SPI_Recv( ( uint8_t * )pData, 1 ) != BSP_ERROR_NONE )
    return BSP_ERROR_COMPONENT_FAILURE;
  EEPROMEX_CTRL_HIGH( Devaddr & EEPROMEX_SPI_SLAVESEL );
  return BSP_ERROR_NONE; 
}

int32_t EEPRMA1_SPI_RecvBuffer(uint8_t * pData, uint32_t TarAddr, 
                               uint32_t DevAddr, const uint16_t Size, const uint8_t Inst )
{
  EEPROMEX_CTRL_LOW( DevAddr & EEPROMEX_SPI_SLAVESEL );
  if (EEPRMA1_M95_IOWrite(Inst) != BSP_ERROR_NONE)
    return BSP_ERROR_COMPONENT_FAILURE;
  if (EEPRMA1_M95_WriteAddr(TarAddr, DevAddr) != BSP_ERROR_NONE ) 
    return BSP_ERROR_COMPONENT_FAILURE;
  if (EEPRMA1_SPI_Recv( pData, Size ) != BSP_ERROR_NONE )
    return BSP_ERROR_COMPONENT_FAILURE;
  EEPROMEX_CTRL_HIGH( DevAddr & EEPROMEX_SPI_SLAVESEL );
  return BSP_ERROR_NONE;
}
...
/**
  ...
  * @retval EEPROMEX enum status
  */
int32_t EEPRMA1_SPI_SendBuffer(uint8_t * pData,uint32_t TarAddr, uint32_t DevAddr, 
                                    const uint16_t Size, const uint8_t Inst)
{
  ...
  if ( EEPRMA1_M95_WriteAddr(TarAddr, DevAddr) != BSP_ERROR_NONE )
    return BSP_ERROR_COMPONENT_FAILURE;
  if ( EEPRMA1_SPI_Send( pData, Size )!= BSP_ERROR_NONE )
    return BSP_ERROR_COMPONENT_FAILURE;
  EEPROMEX_CTRL_HIGH( DevAddr & EEPROMEX_SPI_SLAVESEL );
  return BSP_ERROR_NONE;
}
...
int32_t EEPRMA1_SPI_WriteReg(uint8_t pData, uint32_t Devaddr)
{
  EEPROMEX_CTRL_LOW( Devaddr & EEPROMEX_SPI_SLAVESEL ); 
  ...
  if (EEPRMA1_M95_IOWrite( EEPROMEX_WRSR ) != BSP_ERROR_NONE )
    return BSP_ERROR_COMPONENT_FAILURE;
  if (EEPRMA1_M95_IOWrite( pData ) != BSP_ERROR_NONE )
    return BSP_ERROR_COMPONENT_FAILURE;
  EEPROMEX_CTRL_HIGH( Devaddr & EEPROMEX_SPI_SLAVESEL );
  EEPRMA1_M95_IsDeviceReady( Devaddr);
  return BSP_ERROR_NONE;
}
...
* @retval EEPROMEX enum status
*/
int32_t EEPRMA1_M95_IsDeviceReady(uint8_t Devaddr)
{
  uint8_t status = 0;
  EEPROMEX_CTRL_LOW( Devaddr & EEPROMEX_SPI_SLAVESEL );
  if ( EEPRMA1_M95_IOWrite( EEPROMEX_RDSR ) != BSP_ERROR_NONE )
...
/**
  ...
  * @retval EEPROMEX enum status
  */
int32_t EEPRMA1_M95_IOWrite(uint8_t TxData )
{
  int32_t status = BSP_ERROR_NONE;
  status = EEPRMA1_SPI_Send( &TxData, 1);
  return status;
}
...
/**
  ...
  * @retval EEPROMEX enum status
  */
int32_t EEPRMA1_M95_WriteAddr( const uint32_t TarAddr, const uint32_t DevAddr)
{
  uint8_t AddrSize; 
  ...
  return  EEPRMA1_SPI_Send( Addr, AddrSize );
}

/**
 * @brief  Register Bus IOs for instance M95M01 if component ID is OK
 * @retval BSP status
 */
static int32_t M95M01_0_Probe(void)
{
 ...
 static M95_Object_t M95M01_obj_0;
  ...
  if (M95_RegisterBusIO(&M95M01_obj_0,&io_ctxm01) != M95_OK)
  {
    ret = BSP_ERROR_UNKNOWN_COMPONENT;
  }
  
  M95CompObj[EEPRMA1_M95M01_0] = &M95M01_obj_0;
  M95Drv[EEPRMA1_M95M01_0] = (M95_EEPROM_CommonDrv_t *)(void *)&M95_spi_Drv;
  
  if (M95Drv[EEPRMA1_M95M01_0]->Init(M95CompObj[EEPRMA1_M95M01_0]) != M95_OK)
    {
      ret = BSP_ERROR_COMPONENT_FAILURE;
    }
  else
...
static int32_t M95256_0_Probe(void)
{
 ...
 static M95_Object_t M95256_obj_0;
  ...
  io_ctx256.Init           = EEPRMA1_SPI_Init;
  io_ctx256.DeInit         = EEPRMA1_SPI_DeInit;
  io_ctx256.Read           = EEPRMA1_SPI_ReadReg;
  io_ctx256.Write          = EEPRMA1_SPI_WriteReg;
  io_ctx256.WriteBuffer    = EEPRMA1_SPI_SendBuffer;
  io_ctx256.ReadBuffer     = EEPRMA1_SPI_RecvBuffer;
  io_ctx256.IsReady        = EEPRMA1_M95_IsDeviceReady;
  io_ctx256.Delay          = EEPRMA1_M95_Delay;
  ...
  M95CompObj[EEPRMA1_M95256_0] = &M95256_obj_0;
  
  M95Drv[EEPRMA1_M95256_0] = (M95_EEPROM_CommonDrv_t *)(void *)&M95_spi_Drv;

  if (M95Drv[EEPRMA1_M95256_0]->Init(M95CompObj[EEPRMA1_M95256_0]) != M95_OK)
    {
      ret = BSP_ERROR_COMPONENT_FAILURE;
    }
  else
...
static int32_t M95040_0_Probe(void)
{
  ...
  io_ctx040.Init           = EEPRMA1_SPI_Init;
  io_ctx040.DeInit         = EEPRMA1_SPI_DeInit;
  io_ctx040.Read           = EEPRMA1_SPI_ReadReg;
  io_ctx040.Write          = EEPRMA1_SPI_WriteReg;
  io_ctx040.WriteBuffer    = EEPRMA1_SPI_SendBuffer;
  io_ctx040.ReadBuffer     = EEPRMA1_SPI_RecvBuffer;
  io_ctx040.IsReady        = EEPRMA1_M95_IsDeviceReady;
  io_ctx040.Delay          = EEPRMA1_M95_Delay;
  ...
  M95CompObj[EEPRMA1_M95040_0] = &M95040_obj_0;
  
  M95Drv[EEPRMA1_M95040_0] = (M95_EEPROM_CommonDrv_t *)(void *)&M95_spi_Drv;

 if (M95Drv[EEPRMA1_M95040_0]->Init(M95CompObj[EEPRMA1_M95040_0]) != M95_OK) 
    {
      ret = BSP_ERROR_COMPONENT_FAILURE;
    }
  else
...
/**
  ...
  * @retval None
  */
void EEPRMA1_GPIO_Init( void )
{
  GPIO_InitTypeDef GPIO_InitStruct;
  EEPRMA1_M95_HOLD_RCC(); 
  M95M01_EEPROM_SPI_CS_RCC();
  ...
  GPIO_InitStruct.Pin       = EEPRMA1_M95_WP_PIN;
  GPIO_InitStruct.Mode      = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull      = GPIO_PULLUP;
  GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init( EEPRMA1_M95_WP_PORT, &GPIO_InitStruct );
  HAL_GPIO_WritePin( EEPRMA1_M95_WP_PORT,EEPRMA1_M95_WP_PIN,GPIO_PIN_SET );

      /* EEPROMEX Write protect pin configuration */
  GPIO_InitStruct.Pin       = EEPRMA1_M24_WC_PIN;
  GPIO_InitStruct.Mode      = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull      = GPIO_PULLUP;
  GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init( EEPRMA1_M24_WC_PORT, &GPIO_InitStruct );
  HAL_GPIO_WritePin( EEPRMA1_M24_WC_PORT,EEPRMA1_M24_WC_PIN,GPIO_PIN_SET );
  
    /* EEPROMEX HOLD pin configuration */
  GPIO_InitStruct.Pin       = EEPRMA1_M95_HOLD_PIN;
  GPIO_InitStruct.Mode      = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull      = GPIO_PULLUP;
  GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init( EEPRMA1_M95_HOLD_PORT, &GPIO_InitStruct );
  HAL_GPIO_WritePin( EEPRMA1_M95_HOLD_PORT,EEPRMA1_M95_HOLD_PIN,GPIO_PIN_SET );
    /* EEPROMEX Slave select pin configuration */
  /* Slave one : M95M04 for EEPRMA2 or M95M01 for EEPRMA1*/
  GPIO_InitStruct.Pin       = M95M01_EEPROM_SPI_CS_PIN;
  GPIO_InitStruct.Mode      = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull      = GPIO_PULLUP;
  GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init( M95M01_EEPROM_SPI_CS_PORT, &GPIO_InitStruct );
  HAL_GPIO_WritePin( M95M01_EEPROM_SPI_CS_PORT,M95M01_EEPROM_SPI_CS_PIN,GPIO_PIN_SET );
  /*Slave two : M95256*/
...
/**
  ...
  */
void EEPRMA1_M95MemorySizeLocator(uint32_t Instance)
{
  switch (Instance)
  {    
    case EEPRMA1_M95M01_0:{
     M95PageSize   = 256;        /* Slave Select Pin = ( 1100 1100 & 0000 0011 ) = 0*/
     M95MemorySize = 131072;               /*131072 FOR 1Mb */
    break;
  } 
    case EEPRMA1_M95256_0:{
